...
fprintf(fileId, 'Для `VB-01.alt_50m.BIN` имя файла указывает `alt_50m`, а случай `В-01` в валидационном базисе задан как установившееся висение на высоте 30 м. До ручного подтверждения по журналу это считается несоответствием имени файла и условия ВБ.\n\n');
